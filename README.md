...
Implemented in this alpha: a persistent queue, explicit lifecycle validation, restart recovery, streamed HTTP downloads, partial-file resume, remote identity checks, SHA-256 verification, byte-weighted aggregate progress, a shared CLI, and a live desktop UI. Browser integration, bandwidth limiting, scheduling, and verified installers are not yet implemented.
